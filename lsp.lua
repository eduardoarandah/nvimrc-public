...
local on_attach = function(client, bufnr)
	...
	buf_set_keymap("n", "<localleader>o", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
	buf_set_keymap("n", "<localleader>E", "<cmd>lua vim.diagnostic.goto_prev()<CR>", opts)
	buf_set_keymap("n", "<localleader>e", "<cmd>lua vim.diagnostic.goto_next()<CR>", opts)
