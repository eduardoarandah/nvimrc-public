...
_G.packer_plugins = {
  ...
  ["vim-dadbod-ui"] = {
    after = { "vim-dadbod", "vim-dotenv", "vim-dadbod-completion" },
    commands = { "DBUI" },
...
vim.cmd [[au FileType vue ++once lua require("packer.load")({'vim-prettier', 'emmet-vim'}, { ft = "vue" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'vim-prettier', 'emmet-vim', 'vim-css-color'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType scss ++once lua require("packer.load")({'vim-prettier', 'emmet-vim', 'vim-css-color'}, { ft = "scss" }, _G.packer_plugins)]]
vim.cmd [[au FileType tsx ++once lua require("packer.load")({'emmet-vim'}, { ft = "tsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'vim-prettier'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-prettier', 'markdown-preview.nvim', 'HowMuch'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType php ++once lua require("packer.load")({'vim-prettier', 'emmet-vim'}, { ft = "php" }, _G.packer_plugins)]]
vim.cmd [[au FileType blade ++once lua require("packer.load")({'vim-prettier', 'emmet-vim'}, { ft = "blade" }, _G.packer_plugins)]]
vim.cmd [[au FileType jsx ++once lua require("packer.load")({'vim-prettier', 'emmet-vim'}, { ft = "jsx" }, _G.packer_plugins)]]
